        ...
        return {
            ...
            link: function(scope, element, attrs, ngModel){
                ...
                scope.reflowPopover = function (_el) {
                    ...
                    var offset_top = $("#Content").scrollTop() + 40;
                    ...
                    if(spaceAboveImage < 51) {
                        scope.displayElements.popover.css('top', _el[0].offsetTop + _el[0].offsetHeight - offset_top + 'px');
                        scope.displayElements.popover.removeClass('top').addClass('bottom');
                    } else {
                        scope.displayElements.popover.css('top', _el[0].offsetTop + _el[0].offsetHeight - 54 - offset_top + 'px');
                ...
                scope.reflowResizeOverlay = function (_el) {
                    ...
                    var offset_top = $("#Content").scrollTop();

                    _el = angular.element(_el)[0];
                    scope.displayElements.resize.overlay.css({
                        'display': 'block',
                        'left': _el.offsetLeft - 5 + 'px',
                        'top': _el.offsetTop - offset_top - 5 + 'px',
