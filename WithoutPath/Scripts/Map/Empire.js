var Empire = function (o) {
    ...
    this.render = function () {
        ...
        */
        ...
        _this.circle = new Konva.Circle({
            ...
            fillRadialGradientStartRadius: o.currentRadius * 0.6,
            fillRadialGradientEndPoint: { x: 0, y: 0 },
            fillRadialGradientEndRadius: (_this.currentEase() * 0.008) * o.currentRadius + o.currentRadius * 0.7,
            fillRadialGradientColorStops: [0, 'rgba(249, 195, 44, 1)', 1, 'rgba(0, 0, 0, 0)'],
            scaleX: 0.5,
            scaleY: 0.5
        });
        ...
        var anim = new Konva.Animation(function (frame) {
            _this.circle.fillRadialGradientEndRadius((_this.currentEase() * 0.008) * o.currentRadius + o.currentRadius *0.7);
        }, o.Map.SystemsLevel);
    ...
    this.renderTag = function () {
        ...
        if (_this.SpaceSystem.Security < 0.05 || !_this.SpaceSystem.Security)
            textFill = "#DB3100";
        else if (_this.SpaceSystem.Security <= 0.45)
            textFill = "#F46100";
        else if (_this.SpaceSystem.Security <= 0.55)
            textFill = "#F0F000";
        else if (_this.SpaceSystem.Security <= 0.85)
            textFill = "#00F048";
        else
            textFill = "#31F4F4";
    ...
    this.currentEase = function () {
        ...
        if (!o._easeIsGrow && o._currentEase <= 20)
            o._easeIsGrow = true;
